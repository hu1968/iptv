...
DEFAULT_THIRD_PARTY_URLS = OrderedDict([
    ("https://raw.githubusercontent.com/hu1968/IPTV/main/iptv.txt", "source1.txt"),
    ("https://raw.githubusercontent.com/hu1968/zubo/main/IPTV.txt", "source2.txt"),
])
...
class UpdateLock:
    ...
    def _get_lock_signature(self):
        """获取锁签名"""
        return hashlib.md5(f"{os.getpid()}_{time.time()}".encode()).hexdigest()
            ...
            while True:
                try:
                    ...
                    lock_info = {
                        ...
                        'signature': self._get_lock_signature()
                    }
